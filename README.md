...
```
- to run the Bert NSMC (Naver Sentiment Movie Corpus) example in the src/pytorch-lightning directory, you might need to install additional packages (i.e., emoji and soynlp) and download the nsmc datasets, for example, using git cloning
```
