...
```
(horovod) [glogin01]$ conda install jupyter chardet
...
```
- to run the Bert NSMC (Naver Sentiment Movie Corpus) example in the [src/pytorch-lightning](https://github.com/hwang2006/KISTI-DL-tutorial-using-horovod/tree/main/src/pytorch-lightning) directory, you might need to install additional packages (i.e., emoji, soynlp, transformer and pandas) and download the nsmc datasets, for example, using git cloning
```
...
## Reference
* [Distributed training practices on NERSC Perlmutter supercomputer in LBNL](https://github.com/hwang2006/distributed-training-on-perlmutter-using-horovod)
* [Distributed training practices on supercomputer with Pytorch Lightning](https://github.com/hwang2006/distributed-training-on-supercomputer-with-pytorch-lightning)
